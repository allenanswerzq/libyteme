...
COPT_VARS = {
    ...
    "BYTE_RANDOM_HWAES_ARM64_FLAGS": ["-march=armv8-a+crypto"],
    "BYTE_RANDOM_HWAES_ARM32_FLAGS": ["-mfpu=neon"],
    "BYTE_RANDOM_HWAES_X64_FLAGS": [
        "-maes",
        "-msse4.1",
    ],
    "BYTE_RANDOM_HWAES_MSVC_X64_FLAGS": [],
}
